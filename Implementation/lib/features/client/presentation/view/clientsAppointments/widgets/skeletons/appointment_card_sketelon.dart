...
class ClientAppointmentCardSkeleton extends StatefulWidget {
  const ClientAppointmentCardSkeleton({super.key});

  @override
  State<ClientAppointmentCardSkeleton> createState() =>
      _ClientAppointmentCardSkeletonState();
}

class _ClientAppointmentCardSkeletonState
    extends State<ClientAppointmentCardSkeleton>
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.whiteColor.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
          // Avatar
