...
class ClientProfileSkeleton extends StatefulWidget {
  const ClientProfileSkeleton({super.key});

  @override
  State<ClientProfileSkeleton> createState() => _ClientProfileSkeletonState();
}

class _ClientProfileSkeletonState extends State<ClientProfileSkeleton>
